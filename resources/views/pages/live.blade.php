...
<div class="section"><div class='section-container'>
	<div class="resources">
		...
		<div id="schedule-container" class="live-container">
			...
			<table id="schedule-saturday">
			    <tr class="schedule-item">
			    	<td>Check In</td>
					<td class="schedule-time">CL50 224, 9:30am</td>
			    </tr>
			    <tr class="schedule-item">
			    	<td>Opening Ceremonies</td>
					<td class="schedule-time">CL50 224, 10:30am</td>
			    </tr>
			    <tr class="schedule-item">
			    	<td>Hacking Starts</td>
					<td class="schedule-time">LWSN, 11:00am</td>
			    </tr>
			    <tr class="schedule-item">
			    	<td>Team Building</td>
					<td class="schedule-time">LWSN Commons, 11:00am</td>
			    </tr>
			    <tr class="schedule-item">
			    	<td>Lunch</td>
					<td class="schedule-time">LWSN Commons, 12:30pm</td>
			    </tr>
			    <tr class="schedule-item">
			    	<td>Talk: Making Art with Code</td>
					<td class="schedule-time">LWSN 1106, 1:00pm</td>
			    </tr>
			    <tr class="schedule-item">
			    	<td>Talk: Web scraping and APIs</td>
					<td class="schedule-time">LWSN 1106, 3:00pm</td>
			    </tr>
			    <tr class="schedule-item">
			    	<td>Dinner</td>
					<td class="schedule-time">LWSN Commons, 6:00pm</td>
			    </tr>
			    <tr class="schedule-item">
			    	<td>Talk: Xtern Internships</td>
					<td class="schedule-time">LWSN 1106, 6:00pm</td>
			    </tr>
			    <tr class="schedule-item">
			    	<td>CSWN Puzzle Challenge</td>
					<td class="schedule-time">LWSN 1106, 8:00pm</td>
			    </tr>
			    <tr class="schedule-item">
			    	<td>Talk: Intro to APIs</td>
					<td class="schedule-time">LWSN 1106, 9:00pm</td>
			    </tr>
			    <tr class="schedule-item">
			    	<td>Late Night Snack</td>
					<td class="schedule-time">LWSN Commons, 11:00pm</td>
			    </tr>
			</table>
		...
		<div id="msg-container" class="live-container">
			<div id="msg-title">Hello World</div>
